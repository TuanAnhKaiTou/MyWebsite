...
(`name`, `img`, `keyword`, `sku`,`content`,`description`,`price`,`discount`,`brand`,`idcat`) values
('$name', '$img', '$keyword', '$sku','$content','$description','$price','$discount','$brand','$idcat')
";	
if($db->myquery($sql))
message("Thành Công",$cmd,'manager');
else
...
<form name="frmadd" action="" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="price" name="price" placeholder="ex: 10000 or 100000">
  </div>
   <div class="form-group">
    <label for="discount">Discount:</label>
    <input type="text" class="form-control" id="discount" name="discount" placeholder="ex: 10 or 100">
  </div>
  <div class="form-group">
...
function edit()
{
	...
	if(isset($_POST['btnsub']))
	{
		...
		`keyword`='$keyword',`sku`='$sku',`idcat`='$idcat',
